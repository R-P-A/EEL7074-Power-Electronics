...
orig_30_in_r = na.plot_oscope_original(
...
orig_30_in_rl = na.plot_oscope_original(
    ...
    output_path = "img/lab5/orig_30_in_rl.png"
)

orig_60_in_r = na.plot_oscope_original(
    ...
    output_path = "img/lab5/orig_60_in_r.png"
)

orig_60_in_rl = na.plot_oscope_original(
    ...
    output_path = "img/lab5/orig_60_in_rl.png"
)

orig_30_out_r = na.plot_oscope_original(
    output_name = "Gradador com Alfa 30° e Carga R - Entrada",
    ch1_name = "Vin (V)",
    ch2_name = "Iin (A)",
    ch1_2_scale = 100,
    ...
    output_path = "img/lab5/orig_30_out_r.png"
)

orig_30_out_rl = na.plot_oscope_original(
    output_name = "Gradador com Alfa 30° e Carga RL - Entrada",
    ch1_name = "Vin (V)",
    ch2_name = "Iin (A)",
    ch1_2_scale = 100,
    ...
    output_path = "img/lab5/orig_30_out_rl.png"
)

orig_60_out_r = na.plot_oscope_original(
    output_name = "Gradador com Alfa 60° e Carga R - Entrada",
    ch1_name = "Vin (V)",
    ch2_name = "Iin (A)",
    ch1_2_scale = 100,
    ...
    output_path = "img/lab5/orig_60_out_r.png"
)

orig_60_out_rl = na.plot_oscope_original(
    output_name = "Gradador com Alfa 60° e Carga RL - Entrada",
    ch1_name = "Vin (V)",
    ch2_name = "Iin (A)",
    ch1_2_scale = 100,
    ...
    output_path = "img/lab5/orig_60_out_rl.png"
)
...
fft_vin_30_r = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_30_in_r.index.values,
    values = orig_30_in_r["Vin (V)"].values,
    y_name = "Tensão (V)",
...
fft_iin_30_r = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_30_in_r.index.values,
    values = orig_30_in_r["Iin (A)"].values,
    y_name = "Corrente (A)",
...
fft_vin_30_rl = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_30_in_rl.index.values,
    values = orig_30_in_rl["Vin (V)"].values,
    y_name = "Tensão (V)",
...
fft_iin_30_rl = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_30_in_rl.index.values,
    values = orig_30_in_rl["Iin (A)"].values,
    y_name = "Corrente (A)",
...
fft_vin_60_r = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_60_in_r.index.values,
    values = orig_60_in_r["Vin (V)"].values,
    y_name = "Tensão (V)",
...
fft_iin_60_r = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_60_in_r.index.values,
    values = orig_60_in_r["Iin (A)"].values,
    y_name = "Corrente (A)",
...
fft_vin_60_rl = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_60_in_rl.index.values,
    values = orig_60_in_rl["Vin (V)"].values,
    y_name = "Tensão (V)",
...
fft_iin_60_rl = na.plot_fourier_transform(
    number_samples = 2500,
    time = orig_60_in_rl.index.values,
    values = orig_60_in_rl["Iin (A)"].values,
    y_name = "Corrente (A)",
...
print("THD for Current Alfa 60° RL Load: %s" % (THD))