...
print ("Currente Average for Output R Load: %s" % (na.calculate_mean(orig_out_r["Iout (A)"].values, 231)/3))
...
print ("Currente Average for Output RL Load: %s" % (na.calculate_mean(orig_out_rl["Iout (A)"].values, 231)/3))
